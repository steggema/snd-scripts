...
#   return
#else
/cvmfs/sndlhc.cern.ch/SNDLHC-2023/Aug30/sw/slc7_x86-64/Python/v3.8.12-local1/bin/python $SNDLHC_mymaster/snd-scripts/digi_to_ml.py -mc $MC_PATH -t $etype -p $partition -o $OUTPUTDIR
#fi
